...
const EbookManagement = () => {
  ...
  const addEbook = async () => {
    try {
      ...
      const errorMessage = err.response?.data?.msg || "Error adding Vehicle";
      console.error(err);
  ...
  const handleDeleteConfirm = async () => {
    try {
      ...
      const errorMessage = err.response?.data?.msg || "Error deleting Vehicle";
      console.error(err);
      toast.error(errorMessage);
    }
  };
  ...
  const updateEbook = async () => {
    try {
      ...
      const errorMessage = err.response?.data?.msg || "Error updating Vehicle";
      console.error(err);
      toast.error(errorMessage);
    }
  };
  ...
  return (
    <Container sx={{ paddingTop: 5 }}>
      ...
      <Grid container spacing={2} sx={{ marginBottom: 3 }}>
        ...
        <Grid item xs={12} sm={4}>
          <TextField
            label="Search Manufacturer Name"
            name="authorName"
